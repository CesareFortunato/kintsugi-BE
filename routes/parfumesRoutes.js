...
//rotta per search
router.get("/search", parfumesControllers.search);
//metto le note sempre nella rotta delle profuziomazioni sperando sia coerente comunque
router.get("/note/:noteId", parfumesControllers.getNote);
//rotta per correlati
router.get("/:public_slug/related", parfumesControllers.related);
